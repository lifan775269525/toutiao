...
_USERRECOMMENDS = _descriptor.ServiceDescriptor(
  name='UserRecommends',
  full_name='UserRecommends',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='user_recommends',
    full_name='UserRecommends.user_recommends',
    index=0,
...
_sym_db.RegisterServiceDescriptor(_USERRECOMMENDS)

DESCRIPTOR.services_by_name['UserRecommends'] = _USERRECOMMENDS
